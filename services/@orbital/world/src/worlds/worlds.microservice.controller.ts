...
> {
  ...
  @MessagePattern()
  async create(
    createDto: WithoutId<World> | WithoutId<World>[]
  ): Promise<World | BulkItemizedResponse<WithoutId<World>, World>> {
  ...
  @MessagePattern()
  async update(
    updateDto: World | World[]
  ): Promise<
    | WithDocument<World>
    | BulkItemizedResponse<World, WithDocument<World>, never>
  > {
