...
describe.skip("ConversationsRepository", () => {
  ...
  beforeEach(async () => {
    ...
    // Import the TempConversationModel class from the module file
    const { TempConversationModel } = require("./conversations.module");
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        {
          provide: getModelToken(TempConversationModel),
          useValue: mockModel,
        },
      ],
    }).compile();
    ...
    conversationModel = module.get(getModelToken(TempConversationModel));
  });
