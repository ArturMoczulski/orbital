...
describe("ONE_TO_ONE Relationship Tests", () => {
  describe("ZodString ONE_TO_ONE references", () => {
    it("should create a ONE_TO_ONE relationship with explicit type", () => {
    ...
    it("should support custom field and name in ONE_TO_ONE relationship", () => {
      const schema = z.object({
  ...
  describe("Practical ONE_TO_ONE examples", () => {
    it("should model a User-Profile one-to-one relationship", () => {
      // In a real application, Profile would have a userId field
      // that references the User's _id in a ONE_TO_ONE relationship
    ...
    it("should model a bidirectional ONE_TO_ONE relationship", () => {
      ...
      expect(userProfileReference?.type).toBe(RelationshipType.ONE_TO_ONE);
      expect(profileUserReference?.type).toBe(RelationshipType.ONE_TO_ONE);
    });
  });
});
